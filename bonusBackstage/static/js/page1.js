...
$('.add')[0].onclick = function () {
  console.log('fp')
  $('#fp')[0].innerHTML = $('#fp')[0].innerHTML += '<br><select id="department"><option disabled="disabled" selected>请选择部门</option><option>全媒体制作一部</option><option>全媒体制作二部</option><option>全媒体制作三部</option><option>时政部</option><option>品牌部</option><option>强国论坛部</option></select><select id="people"><option disabled="disabled" selected>请选择获奖人</option><option>全媒体制作一部</option><option>全媒体制作二部</option><option>全媒体制作三部</option><option>时政部</option><option>品牌部</option><option>强国论坛部</option></select><span class="lab">获奖金额:</span><input class="number-input" type="number">'
}
